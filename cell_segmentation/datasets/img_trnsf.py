...
class Crop(object):
    def __init__(self, crop_size, crop_type="rand", mean=[0.485, 0.456, 0.406], ignore_value=255, p=0.5):
...
def apply_transformations(input_image_path):
    import matplotlib.pyplot as plt

    # Load an example image
    example_image = Image.open(input_image_path)

    # Define the transformation pipeline
    transform_pipeline = build_basic_transfrom()
...
if __name__ == "__main__":
    directory_path = '/Users/piotrwojcik/Downloads/fold_1_256_cls/positive/'
    ...
    # Provide the path to your example image here
    apply_transformations(random_image_path)